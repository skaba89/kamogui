    ...
    <>
      <div className="topbar">
        <div className="container">
          <span>📍 Afrique · Europe · Amérique · Moyen-Orient · Asie</span>
          <span>☎ +1 (514) 123-4567 &nbsp; ✉ contact@kamogui.com</span>
        </div>
      </div>
          ...
          <nav className="menu">
            ...
            <div className="dropdown">
              ...
              <div className="dropdownMenu">
                ...
                <Link href="/investor-dashboard">Dashboard investisseur</Link>
      ...
      <footer className="footerPremium">
        <div className="container footerGrid">
          <div>
            ...
            <p className="muted">
              Approvisionnement responsable, traçabilité, conformité et
              exportation d’or physique vers les marchés internationaux.
            </p>
